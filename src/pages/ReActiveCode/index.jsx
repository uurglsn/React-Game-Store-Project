                ...
                <div className=' font-mainFont  dark:from-sky-100 dark:to-teal-100 dark:text-black  text-sky-700 bg-gradient-to-br from-gray-700 via-gray-900 to-black    border-r-4 border-black w-full '>
                    ...
                    <div className=" flex mb-5  justify-center pt-10">
                        <div className="flex flex-col   gap-5">
                            ...
                            <h1>{languages[language].auth.needMailForActive}</h1>
                            ...
                            <div className="flex max-sm:items-center  max-sm:flex-col  gap-3">
                                ...
                                {captchaIsDone ? <button className='  bg-black   flex items-center justify-center w-64 max-sm:w-40      hover:bg-white hover   dark:hover:text-black hover:text-black  transition-colors rounded-xl  max-xl:col-span-2 dark:text-white max-xl:place-self-center'>{languages[language].auth.submitButton}</button> : ""}
                            </div>
                        </div>
                    </div>
                </div>
