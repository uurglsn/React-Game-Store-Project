...
import { login, googleProvider, twitterProvider, microsoftProvider, facebookProvider, auth } from "../../../../firebase/auth"
            ...
            >
                {
                    ({ handleSubmit, handleChange }) => (
                        <Form onSubmit={handleSubmit}>
                            <div className='flex justify-center '>
                                <div className='grid max-sm:gap-x-3  mt-6 gap-y-6  gap-x-16    grid-cols-2'>
