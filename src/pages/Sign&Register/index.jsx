    ...
    return (
        <div className=' overflow-auto   max-h-screen flex  h-screen w-screen '>
            ...
            <div className=' font-mainFont  dark:from-sky-100 dark:to-teal-100 dark:text-black  text-sky-700 bg-gradient-to-br from-gray-700 via-gray-900 to-black    border-r-4 border-black  max-xl:w-full  w-1/2'>
                ...
                {signOrRegister ? (<div className='flex justify-center '>
                    <div className='grid max-sm:gap-x-3  gap-y-6  gap-x-16    grid-cols-2'>
                        ...
                        <div className="p-4 flex  justify-center  col-span-2 mb-4 text-sm text-red-800 rounded-lg bg-red-50  dark:text-red-400" role="alert">Change a few things up and try submitting again.</div>
